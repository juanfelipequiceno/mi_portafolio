...
public class ModificarVendedor extends javax.swing.JFrame {
    ...
    Vendedor cedulaGlobal;
    
    public ModificarVendedor(InterVendedor vendedor) {
        this.vendedor = vendedor;
        this.cedulaGlobal = cedulaGlobal;
    ...
    private void initComponents() {
        ...
        btn_cambiarContra.setBackground(new java.awt.Color(0, 0, 0));
        btn_cambiarContra.setForeground(new java.awt.Color(255, 255, 255));
        btn_cambiarContra.setText("Cambiar Contraseña");
        ...
        contentPrincipalLayout.setHorizontalGroup(
            ...
            .addGroup(contentPrincipalLayout.createSequentialGroup()
                .addGap(154, 154, 154)
                .addComponent(btn_cambiarContra)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        cedulaGlobal = this.vendedor.ventana.data_base.buscarVendedor(cedula);
        ...
        if(campoCedula.equals(" ") == false){
            btn_cambiarContra.setEnabled(true);
        }
    ...
    private void btn_cambiarContraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_cambiarContraActionPerformed
        modificarContraseña ventanaContra = new modificarContraseña(this, cedulaGlobal);
    ...
    public void initAlternComponents(){
        ...
        deshabilitarCampo(campoTelefono);
        deshabilitarCampo(campoEmail);
        btn_cambiarContra.setEnabled(false);
    }
